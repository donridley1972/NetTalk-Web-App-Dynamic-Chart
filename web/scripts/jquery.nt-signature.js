...
$.widget( "ui.ntsignature", {
        options: {
                ...
                clearText: 'Clear',
				clearCss: 'nt-flex nt-button nt-button-with-icon nt-button nt-default-button ui-button ui-corner-all ui-widget nt-sig-clear-button',
                lineColor:'#ccc',
                lineWidth:2,
                lineMargin:2,
                lineTop: 35,
                css: 'nt-left nt-entry ui-corner-all nt-fit-height',
                sp:0
        },
...
//------------------------------------------------------
        addControl : function() {
                ...
                if (this.options.clearButton){
                        cb = '<button type="button" id="' + this.options.id + '_clear'+'" class="' + this.options.clearCss + '">'+ this.options.clearText +'</button>'
                }
