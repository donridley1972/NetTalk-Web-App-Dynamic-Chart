   ...
   MEMBER('web46.clw')                                     ! This is a MEMBER module
                     ...
                     MAP
                       INCLUDE('WEB46005.INC'),ONCE        !Local module procedure declarations
                     END
...
Header  Routine
  ...
  packet.append('<head>' & p_web.CRLF &|
      '<title>'&p_web.Translate('NetTalk Example Site')&'</title>' & p_web.CRLF &|
...
body  Routine
  packet.append(p_web.AsciiToUTF(|
    ...
    '<<br /><13,10>'&|
    '<<a href="somepage">Page with progress<</a><13,10>'&|
    '<<br /><13,10>'&|
    '<<!-- Net:MailboxesBrowseControl --><13,10>'&|
